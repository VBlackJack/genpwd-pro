# Instructions de Build Windows - GenPwd Pro v3.0.2
...
```
release/
├── GenPwd Pro-3.0.2-win-x64.exe        # Installeur NSIS (recommandé)
├── GenPwd Pro-3.0.2-win-x64.zip        # Version portable
├── GenPwd Pro-3.0.2-portable.exe       # Exécutable portable
...
- **Fichier:** `GenPwd Pro-3.0.2-win-x64.exe`
- **Taille:** ~150-200 MB
- **Fonctionnalités:**
  - Installation guidée
...
### 2. Version Portable
- **Fichier:** `GenPwd Pro-3.0.2-portable.exe`
- **Taille:** ~150 MB
- **Fonctionnalités:**
...
### 3. Archive ZIP
- **Fichier:** `GenPwd Pro-3.0.2-win-x64.zip`
- **Taille:** ~140 MB
...
# - GenPwd Pro-3.0.2-win-x64.exe
# - GenPwd Pro-3.0.2-portable.exe
# - GenPwd Pro-3.0.2-win-x64.zip
```
...
```cmd
REM SHA256
certutil -hashfile "release\GenPwd Pro-3.0.2-win-x64.exe" SHA256

REM MD5
certutil -hashfile "release\GenPwd Pro-3.0.2-win-x64.exe" MD5
```
