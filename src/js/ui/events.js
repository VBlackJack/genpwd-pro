...
function promptExportFormat() {
  return new Promise((resolve) => {
    ...
    dialog.innerHTML = `
      <h3>Choisir le format d'export</h3>
      <div class="export-options">
        <button id="export-txt" class="btn export-btn">
          📄 Texte (.txt) - Simple liste
        </button>
        <button id="export-json" class="btn export-btn">
      ...
      <button id="export-cancel" class="btn btn-secondary export-cancel">
        Annuler
      </button>
    `;
